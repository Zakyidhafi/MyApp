package com.zakyidhafi.aplikasikasir.Widget;
...
import com.zakyidhafi.aplikasikasir.Fragment.*;
...
public class inputProdukScanner {
	...
	public void shoping() {
		...
		okBtn.setOnClickListener(new View.OnClickListener(){
				@Override
				public void onClick(View p1) {
					com.zakyidhafi.aplikasikasir.MainActivity.dataBalanjaan.tambah(produk_terindentifikasi, -1);
	...
	public void tambahkanProduk() {
		...
		tambahkanbtn.setOnClickListener(new View.OnClickListener(){
				...
				public void onClick(View p1) {
					...
					if (produk_terindentifikasi == null) com.zakyidhafi.aplikasikasir.MainActivity.dataproduk.tambah(data);
					else com.zakyidhafi.aplikasikasir.MainActivity.dataproduk.perbarui(produk_terindentifikasi, data);
